...
public class Main {
    ...
    public static Set<Candidate> trySet() {
        ...
        candidates.add(new Candidate("Газманов", "Иннокентий", "Павлович", Sex.MALE, 39
                , 5, 4));
        candidates.add(new Candidate("Глазунов", "Илья", "Афанасьевич", Sex.MALE, 39
                , 4, 4));
        candidates.add(new Candidate("Петропавлов", "Никанор", "Гуторович", Sex.MALE, 39
                , 4, 2));
        candidates.add(new Candidate("Герцен", "Литий", "Петрович", Sex.MALE, 39
                , 4, 5));
        candidates.add(new Candidate("Муромский", "Игнатий", "Львович", Sex.MALE, 39
                , 5, 2));
