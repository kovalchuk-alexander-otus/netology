# Домашнее задание к занятию "5.Generics в коллекциях и методах"

Необходимо выполнить и предоставить на проверку следующие задачи:

1. [Первый дженерик класс](./generics/README.md);
2. [Дженерик класс с двумя параметрами](./genericsPlus/README.md);
3. [Наследование дженерик классов](./genericsInheritance/README.md) (со звездочкой *);
